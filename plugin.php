...
/**
 * @wordpress-plugin
 * Plugin Name:       Quotepro Payment Widget
 * Plugin URI:        http://aq3.processmyquote.com/Content/Widget
 * Description:       Plugin to add the ability accept monthly insurance payments from wordpress
 * Version:           2.0.0
 * Author:            Brian Marquis
 * Author URI:        https://plus.google.com/u/1/104998013926973170131/posts
 * Text Domain:       quotepro-payment-widget
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Domain Path:       /lang
 *
 * @package   Quotepro_Payment_Widget
 ...
 *
 * Add the ability to accept monthly insurance payments from your wordpress website
 *
 *
 */
 
class Quotepro_Payment_Widget extends WP_Widget {

    protected $widget_slug = 'quotepro-payment-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			'quotepro-payment-widget',
			__( 'Quotepro Payment Widget', $this->get_widget_slug() ),
			array(
				'classname'  => 'quotepro-payment-widget-class',
				'description' => __( 'Accept payments on your website', 'quotepro-payment-widget' )
			)
		);
	...
	public function form( $instance ) {
		...
		$title = !empty( $instance['title']) ? $instance['title'] : __( 'Make A Payment');
	...
	public function widget_textdomain() {
		...
		load_plugin_textdomain( 'quotepro-payment-widget', false, plugin_dir_path( __FILE__ ) . 'lang/' );
...
add_action( 'widgets_init', create_function( '', 'register_widget("Quotepro_Payment_Widget");' ) );